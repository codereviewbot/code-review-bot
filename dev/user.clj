...
(defn connect-to-heroku-db []
    (alter-var-root #'com.ben-allred.code-review-bot.api.services.mongo/db
        (let [conn-str (str (:heroku-mongodb-uri env/get) "?maxPoolSize=128&waitQueueMultiple=5;waitQueueTimeoutMS=150;socketTimeoutMS=5500;safe=false&w=1;wtimeoutms=5000;fsync=true")]
